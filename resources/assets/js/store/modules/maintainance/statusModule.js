export default {
    ...
    actions:{
        ...
        loadStatus: (context, payload) => {
            axios.get('api/statuses/' + payload.id)
            .then(response => {
        ...
        storeStatus: (context, payload) => {
            ...
            axios.post('api/statuses', payload)
            .then(response => {
                setTimeout(() => {
        ...
        updateStatus: (context, payload) => {
            ...
            axios.patch('api/statuses/' + payload.id, payload)
            .then(response => {
                setTimeout(()=>{
                    context.commit('setServerResponse', response);
                    context.commit('setSubmitState', false);
        ...
        deleteStatus: (context, payload) => {
            axios.delete('api/statuses/' + payload.status.id)
            .then(response => {
                toastr.success('Success', response.data.message);
            })
            .catch(error => {
